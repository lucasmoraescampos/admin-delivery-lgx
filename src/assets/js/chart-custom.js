...
if(jQuery('#chartdiv').length){
    ...
    // Am Charts 
     ...
     if(jQuery('#am-columnlinr-chart').length){
        ...
        lineSeries.stroke = am4core.color("#FC9D20");
     ...
     if(jQuery('#am-polar-chart').length){
        ...
        range.axisFill.fill = am4core.color("#FC9D20");
     ...
     if(jQuery('#am-polarscatter-chart').length){
        ...
        var chart = am4core.create("am-polarscatter-chart", am4charts.RadarChart);
         chart.colors.list = [am4core.color("#FC9D20"),am4core.color("#ffd400"),am4core.color("#00ca00")];
     ...
     if(jQuery('#am-layeredcolumn-chart').length){
        ...
        chart.colors.list = [am4core.color("#ffd400"),am4core.color("#FC9D20")];
     ...
     if(jQuery('#morris-bar-chart').length){
      ...
      ykeys: ['y', 'z', 'a'],
      labels: ['Y', 'Z', 'A'],
      barColors: ['#FC9D20', '#ffd400', '#00ca00']
